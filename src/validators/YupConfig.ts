...
/**
 * Configuration of yup error messages
 * 
 * @param path specify field to be shown on error message
 * @param values specify enum values to be shown on error message
*/
export const yupConfig = (
    ...
    string: {
        ...
        email: `${path} tem um formato de e-mail inválido`,
        url: `${path} deve ter um formato de URL válido`,
    ...
    number: {
        default: `${path} deve ser um número`,
